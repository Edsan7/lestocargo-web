<%@ Page Title="Fazer Cotações" ValidateRequest="false" Language="C#" MasterPageFile="~/Pages/Admin/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="ViewOrders.aspx.cs" Inherits="LestoCargo.Admin.ViewOrders" %>
